    ...
    <div className="space-y-12 pb-12">
      ...
      <SlideUp className="flex flex-col md:flex-row md:items-end justify-between gap-6 pt-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a href="/console/charities" className="flex items-center justify-center px-8 h-12 border border-emerald-400/30 text-emerald-400 hover:bg-emerald-400/10 font-body uppercase tracking-widest font-black rounded-lg transition-all">
            Manage Charities
          </a>
