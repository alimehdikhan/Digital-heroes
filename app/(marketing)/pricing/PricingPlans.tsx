    ...
    <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mx-auto">
      ...
      <StaggerItem className="glass-card rounded-[32px] p-10 flex flex-col h-full relative group border border-white/5 hover:border-white/10 transition-all">
        <div className="mb-8">
          ...
          <div className="flex items-baseline gap-2 mb-4">
            <span className="font-display text-5xl text-white font-bold">$20</span>
        ...
        <form action={createCheckoutSession} className="mt-auto">
          ...
          <Button type="submit" className="w-full h-14 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-body uppercase tracking-widest rounded-xl transition-all font-bold">
            Select Monthly
          </Button>
        </form>
      </StaggerItem>
      ...
      <StaggerItem className="glass-card rounded-[32px] p-10 flex flex-col h-full relative group border-2 border-gold-400/30 shadow-gold-glow overflow-hidden">
        ...
        <div className="mb-8 relative z-10">
          ...
          <div className="flex items-baseline gap-2 mb-4">
            <span className="font-display text-5xl text-gold-400 font-bold">$200</span>
        ...
        <form action={createCheckoutSession} className="mt-auto relative group/btn z-10 space-y-4">
          ...
          {charities && charities.length > 0 && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input type="hidden" name="charityPercentage" value={charityPercentage} />
                <input 
                  type="range" 
                  min="10" 
                  max="100" 
          ...
          <div className="relative">
            ...
            <Button type="submit" className="w-full h-14 btn-primary rounded-xl text-navy-950 font-body uppercase tracking-[0.2em] font-black border-none relative z-10">
              Become a Legend
            </Button>
          </div>
        </form>
